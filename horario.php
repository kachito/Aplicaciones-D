  ...
  <nav class="navbar navbar-inverse">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="home.php"><img src="images/logo2.png" alt="logo"></a>
      </div>
        ...
        <ul class="nav navbar-nav">
          ...
          <li><a href="costruccion.htl" class="dropdown-toggle" data-toggle="dropdown">Asignaturas <i
            ...
            <!-- <ul class="dropdown-menu">
                ...
                <li><a href="construccion.php">Otros...</a></li>
            </ul>-->
          </li>
          <li><a href="notas/form_notas.php">Calificaciones</a></li>
          <li><a href="costruccion.php" class="dropdown-toggle" data-toggle="dropdown">Planificaciones <i
                class="fa fa-angle-down"></i></a>
            <ul class="dropdown-menu">
      ...
      <div class="col-md-12">
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h2 align="center" class="modal-title" id="project-3-label">Horario</h2>
          </div>
          <div class="modal-body">
            <h3 align="center">2015 - 2016</h3>
            <div>
              <div id="about-slider">
                <div id="carousel-slider" class="carousel slide" data-ride="carousel">
                  ...
                  <div class="carousel-inner">
                    <div class="item active">
                      <img src="images/portfolio/horario1.jpg" class="img-responsive" alt="horario">
                    </div>
                    <div class="item">
                      <img src="images/portfolio/horario2.jpg" class="img-responsive" alt="horario">
                    </div>
                    <div class="item">
                      <img src="images/portfolio/horario3.jpg" class="img-responsive" alt="horario">
                    </div>
                    <div class="item">
                      <img src="images/portfolio/horario4.jpg" class="img-responsive" alt="horario">
                    </div>
                    <div class="item">
                      <img src="images/portfolio/horario5.jpg" class="img-responsive" alt="horario">
                    </div>
                    <div class="item">
                      <img src="images/portfolio/horario6.jpg" class="img-responsive" alt="horario">
                    </div>
                    <div class="item">
                      <img src="images/portfolio/horario7.jpg" class="img-responsive" alt="horario">
                    </div>
                  </div>
