        ...
        <div class="row contact-wrap">
            ...
            <form action="Curso_update.php" method="post" action="form-horizontal">
                ...
                <div class="col-sm-8 col-sm-offset-4">
                    <input type="number" name="id_curso" style="visibility:hidden" readonly
                           value="<?php echo $ObjCurso->getid_curso(); ?>">
                </div>
                ...
                <div class="col-sm-5 col-sm-offset-1">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nombre" class="form-control" required="required"
                               value="<?php echo $ObjCurso->getnombre(); ?>">
                    </div>

                    <div class="form-group">
                        <label>Paralelo *</label>
                        <input type="text" name="nombre_curso" class="form-control" required="required"
                               value="<?php echo $ObjCurso->getnombre_curso(); ?>">
                    </div>
