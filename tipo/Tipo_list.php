  ...
  <div class="table-responsive">
    <table class="table table-condensed table-bordered table-hover">
      ...
      foreach ($TipoCollectorObj->showTipo() as $c) {
        ...
        <tbody>
        <tr>
          <td><?php echo $c->getcod_tipo() ?></td>
          <td><?php echo $c->getdescripcion() ?></td>
          <td><a href="form_tipo.php">Nuevo</a></td>
          <td><a href="Tipo_edit.php?id=<?php echo $c->getcod_tipo() ?>">Editar</a></td>
          <td><a href="Tipo_delete.php?id=<?php echo $c->getcod_tipo() ?>">Eliminar</a></td>
        </tr>
        </tbody>
        <?php
      }
