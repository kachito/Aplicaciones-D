    ...
    <section id="contact-page">
      <div class="container">
        ...
        <div class="row contact-wrap">
          ...
          <form action="Password_update.php" method="post" action="form-horizontal">
            <div class="col-sm-8 col-sm-offset-4">
              <input type="number" name="cod_usuario" required="required" style="visibility:hidden" readonly value="<?php echo $ObjPassword->getcod_usuario(); ?>">
            </div>
            <br>
            <br>
