      ...
      <form action="Estudiante_insert.php" method="post" action="form-horizontal">
        ...
        <div class="col-sm-5 col-sm-offset-1">
          ...
          <div class="form-group">
            ...
            <input type="password" name="nombre" class="form-control" required="required">
          </div>
          <div class="form-group">
            <label>Nueva contraseña *</label>
            <input type="password" name="apellido" class="form-control" id="password" required="required" >
          </div>
          <div class="form-group">
            <label>Confirme contraseña *</label>
            <input type="password" name="cedula" class="form-control" required="required" id="confirm_password" onkeyup="check();">
