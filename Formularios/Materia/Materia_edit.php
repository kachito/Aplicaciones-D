...
$ObjMateria = $MateriaCollectorObj->showMateriaId($id);
    ...
    <div class="row contact-wrap">
      ...
      <form action="Materia_update.php" method="post" action="form-horizontal">
        <div class="col-sm-8 col-sm-offset-4">
          ...
          <input type="number" name="cod_materia" required="required" style="visibility:hidden" readonly
                 value="<?php echo $ObjMateria->getcod_materia(); ?>">
        </div>
        ...
        <div class="col-sm-5 col-sm-offset-1">
          ...
          <div class="form-group">
            ...
            <input type="text" name="descripcion" class="form-control" required="required"
                   value="<?php echo $ObjMateria->getdescripcion_mat(); ?>">
          </div>
...
/*
                if($c->getmateria_cod()==$ObjMateria->getcod_materia()){
                  echo '<input type="checkbox"  name="elec[' . $c->getcod_curso() . ']" checked> ' . $c->getdescripcion() . '<br>';
